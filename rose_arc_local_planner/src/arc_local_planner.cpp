        ...
        for(int i = 0; i < num_tang_velocities; ++i)
        {
            ...
            for(int j = 0; j < num_rot_velocities; ++j)
            {
                ...
                for(int k = 1; k < num_dts; ++k)
                {
                    ...
                    trajectory_score.trajectory = FCC_.calculatePoseTrajectory(trajectory_score.velocity, dts, forward_t + 1.0, 3.0);  //! @todo OH [IMPR]: Let extra forward sim time depend on acceleration.
